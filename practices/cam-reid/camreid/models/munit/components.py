# copyed from https://github.com/eriklindernoren/PyTorch-GAN/blob/master/implementations/munit/models.py
...
class Decoder(nn.Module):
    ...
    `a new interpretation that instance normalization performs style normalization by normalizing feature statistics.`
    `we believe that the feature statistics can control the style of the output`
    """
