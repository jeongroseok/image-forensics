...
from ..datasets.spc import SPC2018


class SPC2018DataModule(pl.LightningDataModule):
    name = "spc2018"
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        dataset = SPC2018(self.data_dir, transform=self._default_transforms())
    ...
    def _default_transforms(self) -> Callable:
        return transform_lib.Compose(
            [
                ...
                transform_lib.RandomCrop(self.crop_size),
